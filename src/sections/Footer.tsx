...
const Footer = () => {
    return (
        <section className="w-full flex flex-col justify-center items-center gap-2 py-8 bg-cards-dark-inactive mt-12 mb-4 rounded-xl">
            <h4 className="text-text text-center text-sm">That was Seif Adin in a nutshell</h4>
            <h4 className="text-text text-center text-sm">If you like what you have seen, you can get yours now!</h4>
